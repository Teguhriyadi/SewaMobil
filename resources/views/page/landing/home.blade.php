                    ...
                    <div class="card">
                        <div class="card-body">
                            <p>
                                ...
                                Model : {{ $item['model'] }}
                                <hr>
                                Nomor Plat : {{ $item['nomor_plat'] }}
                                <hr>
                                Tarif : Rp. {{ number_format($item['tarif']) }}
                                <hr>
                            </p>
                            <button onclick="aksi('tambah', '{{ $item['id_manajemen'] }}')" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#basicModal"
                                style="width: 100%">
                                <i class="fa fa-plus fs-7" style="margin-right: 5px"></i> Tambah
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModal">Tambah Data</h5>
                                ...
                                <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <ul class="list-unstyled mb-0">
                                                <li class="d-flex mb-4 align-items-center">
                                                    <p class="mb-0 fw-medium me-2 website-analytics-text-bg">12h
                                                    </p>
                                                    <p class="mb-0">Spend</p>
                                                </li>
                                                <li class="d-flex align-items-center mb-2">
                                                    <p class="mb-0 fw-medium me-2 website-analytics-text-bg">127
                                                    </p>
                                ...
                                <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <ul class="list-unstyled mb-0">
                                                <li class="d-flex mb-4 align-items-center">
                                                    <p class="mb-0 fw-medium me-2 website-analytics-text-bg">268
                                                    </p>
                                        ...
                                        <div class="col-6">
                                            <ul class="list-unstyled mb-0">
                                                <li class="d-flex mb-4 align-items-center">
                                                    <p class="mb-0 fw-medium me-2 website-analytics-text-bg">890
                                                    </p>
